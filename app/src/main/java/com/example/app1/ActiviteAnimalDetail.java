...
public class ActiviteAnimalDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activite_animal_detail);
        ...
        btnRetour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), ActiviteAnimals.class);
                startActivity(i);
            }
        });
